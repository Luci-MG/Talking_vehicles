...
public class map_activity extends AppCompatActivity {
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            databaseReference.child("gps").child("longitude").push().setValue(mCurrentLocation.getLongitude());
            databaseReference.child("gps").child("latitude").push().setValue(mCurrentLocation.getLatitude());
        ...
        mFusedLocationClient
                ...
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(map_activity.this , "Location updates stopped!", Toast.LENGTH_SHORT).show();
                        toggleButtons();
                    }
                });
    }
